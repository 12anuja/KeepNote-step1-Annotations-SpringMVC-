...
public class NoteController {
	...
	public String getAllNotes(ModelMap maps) {
		maps.addAttribute(noteRepository.getAllNotes());
		return "index";
	...
	public String saveNote(@RequestParam("noteId") int noteId,@RequestParam("noteTitle") String noteTitle,
						   @RequestParam("noteContent") String noteContent, @RequestParam("noteStatus") String noteStatus ,ModelMap maps) {
		...
		maps.addAttribute("noteRepository", noteRepository.getAllNotes());
